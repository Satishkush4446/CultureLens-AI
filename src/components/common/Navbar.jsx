    ...
    <header className="sticky top-0 z-50 w-full border-b border-white/5 bg-[#0A0F1E]/80 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <button 
          ...
          type="button"
          className="flex items-center space-x-2 group focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:outline-none rounded-lg p-1 text-left cursor-pointer"
          aria-label="CultureLens AI Home"
        >
        ...
        {location.pathname === '/dashboard' && (
          <button
            onClick={handleLogoClick}
            className="flex items-center space-x-1.5 cursor-pointer rounded-lg bg-sky-500/10 px-4 py-2 text-xs font-semibold text-sky-400 border border-sky-500/20 hover:bg-sky-500 hover:text-white hover:border-sky-500 hover:shadow-lg hover:shadow-sky-500/10 transition-all duration-300 focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:outline-none"
          >
            {/* Search SVG icon */}
